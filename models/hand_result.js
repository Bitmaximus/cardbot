...
class HandResult{
    ...
    toString() {
        switch(this._type){
            case 0: return `__**${hand_rankings[this._type]}**__ - (*${card_name_list[this._quality[0]-2].name}*)`
            case 1: return `__**${hand_rankings[this._type]}**__ - (*${card_name_list[this._quality[0]-2].name}s*)`
            case 2: return `__**${hand_rankings[this._type]}**__ - (*${card_name_list[this._quality[0]-2].name}s & ${card_name_list[this._quality[1]-2].name}s*)`
            case 3: return `__**${hand_rankings[this._type]}**__ - (*${card_name_list[this._quality[0]-2].name}s*)`
            ...
            case 7: return `__**${hand_rankings[this._type]}**__ - (*${card_name_list[this._quality[0]-2].name}s*)`
